...
LOCAL_SOURCE_FOLDERPATH = LOCAL_SOURCE_BASE_FOLDERPATH.joinpath('en_obs-tq2/')

# The output folder below must also already exist!
LOCAL_OUTPUT_FOLDERPATH = LOCAL_SOURCE_BASE_FOLDERPATH.joinpath('en_obs-tq/')

def get_TSV_fields(input_folderpath:Path) -> Tuple[str,str,str]:
    """
    Generator to read the TQ 7-column TSV file for OBS
    ...
    """
    print(f"    Loading OBS TQ links from 7-column TSV…")
    input_filepath = input_folderpath.joinpath(f'tq_OBS.tsv')
