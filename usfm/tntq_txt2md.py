...
# Global variables
resource_type = 'tq'    # should be tn or tq
language_code = u'pt-br'
target_dir = r'C:\DCS\Portuguese-Brazil\pt-br_tq'
translators = []
source_versions = []
...
def appendToManifest(bookId, bookTitle):
    ...
    manifest.write(u"    sort: " + str(usfm_verses.verseCounts[bookId]["sort"]) + "\n")
    manifest.write(u"    path: './" + bookId.lower() + u"'\n")
...
if __name__ == "__main__":
    if len(sys.argv) < 2 or sys.argv[1] == 'hard-coded-path':
        convert(r'C:\DCS\Portuguese-Brazil\TQ')
