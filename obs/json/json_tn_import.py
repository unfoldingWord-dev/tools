...
def main(lang, json_file):
    ...
    for frame in json_array:
        if 'id' in frame and frame['id'] in obsframeset:
            ...
            try:
                ...
                if not intro or not terms or not notes or not footer:
                    print "{0} is malformed and thus can't be parsed to inject the JSON contents. Please fix. Exiting...".format(filepath)
                    sys.exit(1)
