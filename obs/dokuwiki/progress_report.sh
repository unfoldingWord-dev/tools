...
echo 'Open Bible Stories Progress Report' >"$PROGRESS_FILE"
echo >>"$PROGRESS_FILE"
date +%F >>"$PROGRESS_FILE"
echo >>"$PROGRESS_FILE"
echo 'Published Online' >>"$PROGRESS_FILE"
echo >>"$PROGRESS_FILE"
...
echo "You may see these at https://unfoldingword.org/stories/." >>"$PROGRESS_FILE"
...
echo 'Activity on Door43' >>"$PROGRESS_FILE"
echo >>"$PROGRESS_FILE"
