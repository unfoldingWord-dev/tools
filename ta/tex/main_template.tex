...
\starttypescript[noto]
    ...
    \doiffile{ta/tex/<<<[fontface]>>>-<<<[language]>>>.tex}{\input ta/tex/<<<[fontface]>>>-<<<[language]>>>.tex}
\stoptypescript
\input{ta/tex/<<<[fontface]>>>-<<<[language]>>>.tex}
%~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
\definemakeup[tatitle][align=middle]
...
\startfrontmatter % Intro material
    ...
    \startmakeup[tatitle]
    \blank
    {\midaligned { \externalfigure[https://unfoldingword.org/assets/img/icon-ta.png] } }
    \blank
    \stopmakeup
...
\startbodymatter % The body content
    ...
    \setupfooter [state=start]
    ===CHAPTERS===
\stopbodymatter % The body content 
%~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
% The Back Matter
%~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
