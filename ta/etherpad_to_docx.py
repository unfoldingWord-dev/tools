...
DOCXFILE = '/var/www/vhosts/door43.org/httpdocs/data/gitrepo/pages/playground/ta_export.docx'
HTMLFILE = '/var/www/vhosts/door43.org/httpdocs/data/gitrepo/pages/playground/ta_export.html'
...
def html_to_docx(html):
    ...
    if len(err) > 0:
        ...
        log_this('Generated document: [[https://door43.org/playground/ta_export.docx]]', True)
