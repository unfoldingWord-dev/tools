...
v9string = []
v9string.append('https://unfoldingword.org/en/?resource=translation-words')
v9string.append('https://unfoldingword.org/network')
v9string.append('(bita-part1)')
v9string.append('(bita-part2)')
v9string.append('(bita-part3)')
v9string.append('(bita-hq)')
v9string.append('(bita-humanbehavior)')
v9string.append('(bita-plants)')
v9string.append("(bita-phenom)")
v9string.append("(bita-manmade)")
v9string.append("(figs-metonymy)")
v9string.append("(figs-personification)")
v9string.append("(figs-partsofspeech)")
...
v10string.append( 'https://unfoldingword.org' )
v10string.append( '(../bita-part1/01.md)' )
v10string.append( '(../bita-part2/01.md)' )
v10string.append( '(../bita-part3/01.md)' )
v10string.append( "(../bita-hq/01.md)" )
v10string.append( "(../bita-humanbehavior/01.md)" )
v10string.append( "(../bita-plants/01.md)" )
v10string.append( "(../bita-phenom/01.md)" )
v10string.append( "(../bita-manmade/01.md)" )
v10string.append( "(../figs-metonymy/01.md)" )
v10string.append( "(../figs-personification/01.md)" )
v10string.append( "(../figs-partsofspeech/01.md)" )
