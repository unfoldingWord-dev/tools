...
exports.usfmToJSON = exports.pushObject = exports.createUsfmObject = undefined;
...
var createUsfmObject = exports.createUsfmObject = function createUsfmObject(marker) {
  ...
  var type = USFM.getMarkerType(tagProps);
  var isText = true;
  if (tag) {
 ...
 * @param {object} marker - object that contains usfm marker
 */
var saveUsfmObject = function saveUsfmObject(state, tag, marker) {
      ...
      case 'zaln':
        {
          ...
          if (state.inHeader) {
            ...
            if (milestone === '-s') {
              ...
              delete phrase.text;
              _i = startSpan(state, phrase, marker.tag, _i, markers);
            } else if (milestone === '-e') {
              // milestone end
              removeLastNewLine(state);
              _i = endSpan(state, _i, markers, marker.tag + "-e\\*");
            } else {
              _i = processMarkerForSpans(state, marker, _i, markers); // process as regular marker
            }
          }
          break;
        }
      ...
      default:
        {
          ...
          if (marker) {
            ...
            _i = processMarker(state, marker, _i, markers);
          }
        }
    }
  }
